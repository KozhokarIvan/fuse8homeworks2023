...
public class AccountProcessor
{
    ...
    public decimal CalculatePerformed(ref BankAccount bankAccount)
    {
        ...
        return CalculateOperationPerformed(ref lastOperation) +
               ...
               CalculateOperation3Performed(lastOperation) +
               CalculateOperation3Performed(previousOperation) +
    ...
    private decimal CalculateOperation3Performed<TTotalAmount>(TTotalAmount bankOperation) where TTotalAmount : ITotalAmount
    {
        //Some calculation code
        return bankOperation.TotalAmount;
    }
